...
#define bit_predicate_s   18 //14//32   //14 //9
#define bit_object_s      35 //20//64   //20 //15


#define bit_subject_e     17 //31//13 //8  
#define bit_predicate_e   34 //63//19 //14
#define bit_object_e      40 //127 //24

bdd kg;
static const int varnum = 41; //128; // 35; //25; //limited BSBM
/*
 *
...
void ___bdd_construct(int _ss_b, int _pp_b, int _oo_b)
{
	...
	char * bin_p = dec2bin( ( (bit_predicate_e) - (bit_predicate_s)  ), _ss_b );
...
int main(void)
{
	...
	long SP = ((s_counter-1) * (pow(10,N_DIGITS_P))) + (p_counter-1);
