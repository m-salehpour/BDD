...
#define bit_predicate_s   6  //14//32   //14 //9
#define bit_object_s      24 //20//64   //20 //15


#define bit_subject_e     5//31//13 //8  
#define bit_predicate_e   23//63//19 //14
...
void ___bdd_construct(int _ss_b, int _pp_b, int _oo_b)
{
	...
	//binS are switched to accommodate POS

	char * bin_s = dec2bin(bit_subject_e, _pp_b ); 
	...
	char* bin_SP = malloc(bit_object_s+1);
