...
#define bit_predicate_s   7  //14//32   //14 //9
#define bit_object_s      28 //20//64   //20 //15


#define bit_subject_e     6//31//13 //8
...
void ___bdd_construct(int _ss_b, int _pp_b, int _oo_b)
{
	...
	//_ss_b and _pp_b are switched for SP!
...
int main(void)
{
	...
	printf("WALL CLOCK -PS - Time elpased is %d secondsi\n", (wc_end - wc_begin));
	...
	time_spent += (double)(end - begin) / CLOCKS_PER_SEC;
    	printf("CLOCK PS - Time elpased is %f seconds\n", time_spent);
