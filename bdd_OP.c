...
#define bit_predicate_s   19 //14//32   //14 //9
#define bit_object_s      29 //20//64   //20 //15


#define bit_subject_e     18 //31//13 //8  
#define bit_predicate_e   25 //63//19 //14
#define bit_object_e      34 //127 //24

bdd kg;
static const int varnum = 26; //128; // 35; //25; //limited BSBM
/*
 *
