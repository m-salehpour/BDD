...
#define bit_object_s      20 //20//64   //20 //15


#define bit_subject_e     17//31//13 //8  
#define bit_predicate_e   24//63//19 //14
#define bit_object_e      34//127 //24

bdd kg;
static const int varnum = 25; //128; // 35; //25; //limited BSBM
/*
 *
...
void ___bdd_construct(int _ss_b, int _pp_b, int _oo_b)
{
	...
	char * bin_o = dec2bin( ( (bit_object_e) - (bit_object_s)  ), _oo_b );
